...
const Approvals = () => {
  ...
  return (
    <>
      <Header />
      <IonContent className="page-contain approval-contain">
          ...
          <IonCard className="page-section approval-section">
            <IonCard className="section-header">
              ...
              <IonCard className="select-contain">
                ...
                >
                  <IonSelectOption value="1">Applicant 1</IonSelectOption>
                  <IonSelectOption value="2">Applicant 2</IonSelectOption>
                </IonSelect>
                <IonSelect
