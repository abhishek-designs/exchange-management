...
import { TableHead, Inventory, Operator as OperatorItem } from "../../types";
...
const Operator = () => {
  ...
  const [currentOperator, setCurrentOperator] = useState<OperatorItem>({
    id: 1,
    title: "Shell",
    logo: shellLogo,
    itemsNo: 500,
  ...
  return (
    <>
      <Header />
      <IonContent className="page-contain operator-contain">
        <IonCard className="container">
          {/* Header */}
          <IonCard className="main-header">
            {/* Stats */}
            <IonCard className="main-header-left">
              <IonImg src={currentOperator.logo} alt="shell logo" />
              ...
              <IonCard color="primary-light" className="main-stats">
                ...
                <IonCard className="num-stat total-num">
                  <IonText color="primary" className="stat-num">
                    {currentOperator.movableNo}
                  </IonText>
                  <IonText color="primary">Movable</IonText>
                </IonCard>
                <IonCard className="num-stat total-num">
                  <IonText color="primary" className="stat-num">
                    {currentOperator.nonMovableNo}
                  </IonText>
          ...
          <IonCard className="page-section inventory-section">
            <IonCard className="section-header">
              ...
              <IonCard className="section-header-right">
                ...
                <IonButton color="danger-light" className="inactive-btn">
                  <IonIcon
                    icon={funnelOutline}
                    color="danger"
                    className="funnel-icon"
                  />
                  <IonText color="danger">200 Inactive</IonText>
                </IonButton>
              </IonCard>
            </IonCard>
            ...
            <IonCard className="section-main">
              ...
              <IonCard className="main-table approval-table">
                ...
                <IonCard className="table-data">
                  {/* Data row */}
                  {currentOperator.tableDesc.map(data => (
                    <IonCard
                      key={data.itemId}
                      className={`data-row data-row-${data.itemId}`}
                    >
                      <IonCard className="row row-0">
                        <IonCheckbox checked={data.itemChecked} />
                      </IonCard>
                      {/* Name & Type */}
                      ...
                      {/* Status */}
                      <IonCard className="row row-4">
                        <IonCard className="status-card-contain">
                          ...
                          {data.status.inactiveStatus && (
                            <IonCard className="status-card inactive-card">
                              <IonText color="danger">
                                {data.status.inactiveStatus} Inactive
                              </IonText>
                            </IonCard>
                          )}
                        </IonCard>
